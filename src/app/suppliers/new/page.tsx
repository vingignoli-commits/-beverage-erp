    ...
    try {
      const response = await fetch("/api/suppliers", {
        ...
        body: JSON.stringify({
          ...
          defaultTermsDays: form.defaultTermsDays
            ? Number(form.defaultTermsDays)
            : 0,
      ...
      if (!response.ok) {
        throw new Error(result.message || "No se pudo crear el proveedor.");
      }
    ...
    <main style={mainStyle}>
      <div style={containerStyle}>
        <div style={headerStyle}>
          <p style={eyebrowStyle}>Alta de proveedor</p>
          <h1 style={titleStyle}>Nuevo proveedor</h1>
        </div>
        ...
        <form onSubmit={handleSubmit} style={formStyle}>
          <div style={gridStyle}>
            ...
            <Field
              ...
              type="number"
              value={form.defaultTermsDays}
              onChange={(value) => updateField("defaultTermsDays", value)}
            />
          </div>
          ...
          <div style={actionsStyle}>
            <button type="button" onClick={() => router.push("/suppliers")} style={secondaryButtonStyle}>
              Cancelar
            </button>
